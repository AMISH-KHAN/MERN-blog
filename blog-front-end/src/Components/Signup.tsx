...
export default function Signup() {
    ...
    let [user, setUser] = useState<userDatatype>(userInitialState)
    let users=useSelector((state:rootState )=>state.userStateData)
    type getdatafuncobj = (event : ChangeEvent<HTMLInputElement>)=>void
    

    const getdata: getdatafuncobj =(e)=>{
    ...
    type setdatafunc = (event: FormEvent<HTMLFormElement>) => void
    
    const setdata: setdatafunc = (e) => {
...
<div className="min-w-screen min-h-screen  flex items-center justify-center px-5 py-5">
        ...
        <div className="md:flex w-full">
            <div className="hidden md:block w-1/2 bg-gray-900 py-10 px-10">
                    ...
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            ...
                            <div className="flex">
                                ...
                                <input required name="name" onChange={getdata} type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John"/>
                            </div>
                        </div>
                    ...
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            ...
                            <div className="flex">
                                ...
                                <input required name="email" onChange={getdata} type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com"/>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-12">
                            ...
                            <div className="flex">
                                ...
                                <input required name="password" onChange={getdata} type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************"/>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            <button className="block w-full max-w-xs mx-auto bg-gray-700 hover:bg-gray-900 focus:bg-gray-900 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                                  </div>
                    </div>
                                  <h1 className="text-center">Already have an Account <Link to="/login" className="text-blue-600 underline">Login</Link> </h1>
                                  </form>
                          </div>
            </div>
        </div>
